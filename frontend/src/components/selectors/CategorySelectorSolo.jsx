...
export default function CategorySelectorSolo({ categoryIdRef, data }) {
  ...
  useEffect(() => {
    const getCategories = async () => {
      ...
      const allCategoriesOption = { id: 0, nameRu: "Все" };
      const allCategories = data
        ? fetchedCategories
        : [allCategoriesOption, ...fetchedCategories];
      ...
      if (data) {
        ...
        categoryIdRef.current = allCategoriesOption.id;
      }
    };
